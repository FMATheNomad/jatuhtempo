...
JatuhTempo adalah platform manajemen utang yang menyediakan:
- Pencatatan dan pelacakan utang
- OCR otomatis untuk membaca tagihan
- Pengingat pembayaran via Telegram dan WhatsApp
- Dashboard analitik real-time
- Fitur lain yang ditambahkan dari waktu ke waktu
...
- Menyalahgunakan sistem OCR untuk tujuan ilegal
- Mengakses data pengguna lain
- Melakukan reverse engineering pada Platform
- Menggunakan bot atau skrip otomatis yang mengganggu layanan

## 6. Batasan Tanggung Jawab

JatuhTempo disediakan "sebagaimana adanya". Kami tidak bertanggung jawab atas:
- Keputusan keuangan yang Anda buat berdasarkan data di Platform
- Kerugian akibat keterlambatan notifikasi
